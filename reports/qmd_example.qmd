...
![Horse Populations](../results/horse_pops_plot.png){#fig-horse_pop width=60% height=60%}
...
We present the standard deviations in @tbl-horse_sd.

@tbl-horse_sd. Standard deviation of historical (1906-1972) horse populations for each Canadian province.
...
Additionally, note that in @tbl-horse_sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pop.

![Saskatchewan Horse Population](../results/horse_pops_plot_largest_sd.png)

@fig-sas-horse-pop: Horse populations for the province with the largest standard deviation

In @fig-sas-horse-pop we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
